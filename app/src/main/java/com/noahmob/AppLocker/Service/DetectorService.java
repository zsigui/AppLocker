    ...
    private class MonitorlogThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                ActivityManager am = (ActivityManager) DetectorService.this.getBaseContext().getSystemService
                        (ACTIVITY_SERVICE);
                if (VERSION.SDK_INT <= 19) {
                    RunningTaskInfo foregroundTaskInfo = (RunningTaskInfo) am.getRunningTasks(1).get(0);
                    String foregroundTaskPackageName = foregroundTaskInfo.topActivity.getPackageName();
                    PackageManager pm = DetectorService.this.getBaseContext().getPackageManager();
